...
import com.jphill.basketball.database.tables.GameStatsTable
...
object PlayerHelper {
    ...
    fun createPlayer(id: Int): Player? {
        return PlayerTable.select { PlayerTable.id eq id }.firstOrNull()?.let { makePlayer(it) }
    }
    ...
    fun createStats(pRow: ResultRow, sRow: ResultRow): PlayerStats = PlayerStats(
